...
public class EmailService {
    ...
    public void sendMaturityNotification(String toEmail, String username, String investmentType,
                                         String institute, String maturityDate, BigDecimal amount) {
        try {
            ...
            logger.info("✅ Maturity notification email sent to: " + toEmail);

        } catch (Exception e) {
            logger.error("❌ Failed to send maturity notification email to " + toEmail + ": " + e.getMessage());
